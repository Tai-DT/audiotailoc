...
export class BookingService {
  ...
  async deleteBooking(id: string) {
    ...
    // Delete related status history records first to avoid foreign key constraint
  ...
  async getBookingStats(params?: {
    ...
    const [
      ...
      this.prisma.service_bookings.count({ where }),
      this.prisma.service_bookings.count({ where: { ...where, status: ServiceBookingStatus.PENDING } }),
      this.prisma.service_bookings.count({ where: { ...where, status: ServiceBookingStatus.CONFIRMED } }),
      this.prisma.service_bookings.count({ where: { ...where, status: ServiceBookingStatus.IN_PROGRESS } }),
      this.prisma.service_bookings.count({ where: { ...where, status: ServiceBookingStatus.COMPLETED } }),
      this.prisma.service_bookings.count({ where: { ...where, status: ServiceBookingStatus.CANCELLED } }),
