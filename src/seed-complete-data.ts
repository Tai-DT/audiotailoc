...
async function seedData() {
  ...
  try {
    ...
    // ========================================
    console.log('\n🔔 Skipping Notifications (feature disabled)...');
    ...
    */
    ...
    // 9. SEED PROMOTIONS
    // ========================================
    const shouldSeedPromotions = String(process.env.SEED_SAMPLE_PROMOTIONS || '').toLowerCase() === 'true';
    if (shouldSeedPromotions) {
      console.log('\n🎁 Creating Promotions (sample data enabled)...');
      const promotions = [
        {
          code: 'NEWYEAR2025',
      ...
      console.log('\n🎁 Skipping promotions sample data (set SEED_SAMPLE_PROMOTIONS=true to seed).');
    }
