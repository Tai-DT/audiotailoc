...
import { UrlValidator } from '../../common/security/url-validator';
  ...
  async uploadFromUrls(
    ...
    try {
      ...
      if (body.thumbnailUrl) {
        ...
        const { url: validatedUrl, fetchOptions } = UrlValidator.validateUrlForFetch(
          body.thumbnailUrl,
          undefined, // No domain whitelist - allow any public domain
