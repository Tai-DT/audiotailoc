...
export class BookingController
{
  ...
  @Patch( ':id' )
  @UseGuards( JwtGuard )
  async update ( @Param( 'id' ) id: string, @Body() updateBookingDto: UpdateBookingDto, @Req() req: any )
  {
  ...
  @Patch( ':id/status' )
  @UseGuards( JwtGuard )
  async updateStatus ( @Param( 'id' ) id: string, @Body() updateStatusDto: UpdateBookingStatusDto, @Req() req: any )
  {
