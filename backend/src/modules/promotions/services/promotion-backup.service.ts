  ...
  async backupPromotion(
    ...
    const backup: PromotionBackup = {
      ...
      data: {
        ...
        tierBased: promotion.tierBased || false,
        isFirstPurchaseOnly: promotion.isFirstPurchaseOnly || false,
        customerSegment: promotion.customerSegment || undefined,
        conditions: promotion.conditions,
        versionNumber: promotion.versionNumber || 1,
      ...
      if (existingPromotion) {
        ...
        const restored = await this.prisma.promotions.update({
          ...
          data: {
            ...
            startsAt: backup.data.startsAt,
            expiresAt: backup.data.expiresAt,
            minOrderAmount: backup.data.minOrderAmount,
            maxDiscount: backup.data.maxDiscount,
            usageLimit: backup.data.usageLimit,
            tierBased: backup.data.tierBased,
            isFirstPurchaseOnly: backup.data.isFirstPurchaseOnly,
            customerSegment: backup.data.customerSegment,
            conditions: backup.data.conditions,
            versionNumber: (backup.data.versionNumber || 1) + 1,
            updatedAt: new Date(),
          },
        });
