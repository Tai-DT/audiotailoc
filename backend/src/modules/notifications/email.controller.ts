      ...
      switch (id) {
        ...
        case 'invoice':
          ...
          htmlContent = invoiceTemplates.standard({
            ...
            // customerAddress: '456 Đường XYZ, Quận 3, TP.HCM', // Field does not exist in InvoiceData
            taxCode: '0123456789',
            items: [
              {
                ...
                quantity: 1,
                price: '2.500.000 ₫',
                // total: '2.500.000 ₫', // Field does not exist in type
              },
              {
                name: 'Tai nghe Marshall',
                quantity: 2,
                price: '3.000.000 ₫',
                // total: '6.000.000 ₫', // Field does not exist in type
              },
            ],
            subTotal: '8.500.000 ₫',
            taxAmount: '850.000 ₫',
