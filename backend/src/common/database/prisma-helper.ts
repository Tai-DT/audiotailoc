...
export class PrismaHelper {
  ...
  get banner() {
    return this.prisma.banners;
  }
  get blogArticle() {
    return this.prisma.blog_articles;
  }
  get blogCategory() {
    return this.prisma.blog_categories;
  }
  get blogComment() {
    return this.prisma.blog_comments;
  }
  get cart() {
    return this.prisma.carts;
  }
  get cartItem() {
  ...
  get paymentIntent() {
    return this.prisma.payment_intents;
  }
  get product() {
  ...
  get productReview() {
    return this.prisma.product_reviews;
  }
  ...
  get serviceBooking() {
    return this.prisma.service_bookings;
  }
  get serviceBookingItem() {
    return this.prisma.service_booking_items;
  }
  get serviceItem() {
    return this.prisma.service_items;
  }
  get serviceType() {
    return this.prisma.service_types;
  }
  // get session() { return this.prisma.sessions; } // Not in schema
  get systemConfig() {
    return this.prisma.system_configs;
  }
  // get tag() { return this.prisma.tags; } // Not in schema
  get technician() {
    return this.prisma.technicians;
  }
  get technicianSchedule() {
    return this.prisma.technician_schedules;
  }
  get user() {
    return this.prisma.users;
  }
  get wishlistItem() {
    return this.prisma.wishlist_items;
  }
