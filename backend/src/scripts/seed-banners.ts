    ...
    const banners = [
      {
        ...
        description: 'Mang không gian sân khấu chuyên nghiệp về ngay phòng khách nhà bạn với các giải pháp âm thanh từ JBL, Bose, BMB.',
      ...
      },
      {
        ...
        description: 'Cơ hội sở hữu thiết bị âm thanh chính hãng với mức giá tốt nhất năm. Tặng phụ kiện và gói lắp đặt chuyên nghiệp.',
      ...
      },
      {
        ...
        description: 'Khám phá hàng ngàn sản phẩm từ Loa, Amply, Micro đến các bộ dàn Karaoke trọn gói.',
      ...
      },
      {
        ...
        description: 'Đội ngũ kỹ thuật viên giàu kinh nghiệm, khảo sát và lắp đặt tận nơi. Bảo hành, bảo trì định kỳ uy tín.',
