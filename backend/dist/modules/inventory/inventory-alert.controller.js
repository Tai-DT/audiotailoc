...
let InventoryAlertController = class InventoryAlertController {
    constructor(inventoryAlertService) {
    ...
    async findAll(page, pageSize, productId, type, isResolved, startDate, endDate) {
        ...
        return this.inventoryAlertService.findAll(params);
    }
    async findByProduct(productId, page, pageSize) {
        ...
        return this.inventoryAlertService.findByProduct(productId, params);
    }
    async getActiveAlerts() {
        return this.inventoryAlertService.getActiveAlerts();
    }
    async getAlertSummary() {
        return this.inventoryAlertService.getAlertSummary();
    }
    async resolve(id) {
        return this.inventoryAlertService.resolve(id);
    }
    async bulkResolve(data) {
        return this.inventoryAlertService.bulkResolve(data.ids);
    }
    async checkAndCreateAlerts() {
        return this.inventoryAlertService.checkAndCreateAlerts();
    }
    async delete(id) {
        return this.inventoryAlertService.delete(id);
    }
    async bulkDelete(data) {
        return this.inventoryAlertService.bulkDelete(data.ids);
    }
};
...
exports.InventoryAlertController = InventoryAlertController = __decorate([
    ...
    __metadata("design:paramtypes", [inventory_alert_service_1.InventoryAlertService])
