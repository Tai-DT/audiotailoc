...
export declare class BlogService {
    ...
    getArticles(query?: BlogArticleQuery): Promise<{
        data: ({
            blog_categories: {
                description: string;
                id: string;
    ...
    createArticle(dto: CreateBlogArticleDto, authorId: string): Promise<{
        blog_categories: {
            description: string;
            id: string;
            name: string;
    ...
    getCategories(query?: BlogCategoryQuery): Promise<{
        data: ({
            _count: {
    ...
    getComments(articleId: string, approved?: boolean, page?: number, limit?: number): Promise<{
        data: ({
            users: {
                id: string;
                email: string;
    ...
    createComment(dto: CreateBlogCommentDto, authorId?: string): Promise<{
        users: {
            id: string;
            email: string;
            name: string;
