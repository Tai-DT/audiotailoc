...
let SeoService = SeoService_1 = class SeoService {
    constructor(prisma, configService) {
        ...
        const configuredSiteUrl = this.configService.get('SITE_URL');
    ...
    async generateSitemap() {
        const [products, categories, pages, projects, services, blogArticles, blogCategories, softwareItems,] = await Promise.all([
