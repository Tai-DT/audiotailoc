...
exports.GuardsModule = GuardsModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        imports: [config_1.ConfigModule, (0, common_1.forwardRef)(() => users_module_1.UsersModule)],
        providers: [admin_guard_1.AdminGuard, admin_or_key_guard_1.AdminOrKeyGuard, jwt_guard_1.JwtGuard, prisma_service_1.PrismaService],
