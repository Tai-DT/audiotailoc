...
let InventoryAlertsService = class InventoryAlertsService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
    ...
    async checkAndCreateAlerts(productId) {
...
exports.InventoryAlertsService = InventoryAlertsService;
exports.InventoryAlertsService = InventoryAlertsService = __decorate([
