...
function ProductsPageContent() {
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-white selection:bg-primary/30" role="main" aria-labelledby="products-title">
            ...
            <section className="relative py-16 md:py-28 overflow-hidden border-b border-white/5">
                {/* Dynamic Background */}
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <BlurFade delay={0.1} inView>
                        <div className="flex flex-col items-center text-center space-y-4 md:space-y-6">
                            ...
                            <h1 id="products-title" className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[1.1] md:leading-[1] max-w-5xl">
                                {currentCategory ? (
                                    <>
