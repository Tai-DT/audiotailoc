...
export default function ProductDetailPage({ params }: ProductDetailPageProps) {
 ...
 <section className="relative pt-6 lg:pt-12 pb-20 z-10">
 ...
 <div className="relative bg-muted/40 border border-border rounded-[2rem] p-4 backdrop-blur-3xl">
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-primary">Phiên bản Elite</span>
 </div>
 )}
 </div>
 <div className={cn(
 ...
 <h1 className="text-3xl md:text-4xl xl:text-5xl font-black tracking-tight leading-[1.1]">
 {product.name}
 </h1>
 {product.brand && (
 ...
 <span className="text-muted-foreground text-xs font-bold uppercase tracking-wider">{totalReviews} Đánh giá</span>
 </div>

 {/* Price Block - High Impact */}
 <div className="relative p-8 rounded-[2rem] bg-gradient-to-br from-card to-muted/20 border-2 border-primary/20 overflow-hidden group hover:border-primary/50 transition-all duration-500 hover:shadow-[0_0_50px_-20px_rgba(220,38,38,0.3)]">
 ...
 <span className="text-5xl md:text-6xl font-black tracking-tighter text-primary drop-shadow-sm">
 ...
 <Badge className="bg-red-600 text-foreground dark:text-white font-black text-xs tracking-widest px-3 py-1 rounded-sm shadow-md animate-pulse">-{discount}% OFF</Badge>
 <span className="text-xs font-bold text-green-500 uppercase tracking-widest italic">Tiết kiệm {formatPrice(product.originalPriceCents! - product.priceCents)}</span>
 </div>
 )}
 </div>
 </div>
 ...
 size="lg"
 className={cn(
 "h-16 rounded-2xl font-black text-sm uppercase tracking-[0.2em]",
 ...
 size="lg"
 className={cn(
 "h-16 rounded-2xl font-black text-sm uppercase tracking-[0.2em] italic",
 ...
 className={cn(
 "flex-1 flex items-center justify-center gap-3 h-12 rounded-xl border border-border text-[10px] font-black uppercase tracking-widest transition-all hover:bg-muted/40",
 ...
 <button
 onClick={handleShare}
 className="flex-1 flex items-center justify-center gap-3 h-12 rounded-2xl border border-border text-[10px] font-black uppercase tracking-widest hover:bg-muted/40 transition-all"
 >
 ...
 <section className="relative py-20 z-10 border-t border-border bg-muted/30">
 <div className="container mx-auto px-6">
 <BlurFade delay={0.3} inView>
 <Tabs defaultValue="description" className="w-full">
 <div className="flex justify-center mb-12">
 <TabsList className="bg-muted/40 border border-border p-1.5 rounded-2xl h-16 w-full max-w-2xl">
 {[
 ...
 value={tab.value}
 className={cn(
 "flex-1 h-full rounded-xl text-[10px] font-black uppercase tracking-widest leading-none",
 ...
 <div className="p-10 rounded-[2.5rem] bg-card border border-border backdrop-blur-3xl prose prose-slate max-w-none">
 {product.description ? (
 <div className="leading-relaxed text-muted-foreground italic text-lg" dangerouslySetInnerHTML={{ __html: product.description }} />
 ) : (
 <div className="flex flex-col items-center py-20 text-muted-foreground">
 <Package className="w-12 h-12 mb-4 opacity-50" />
 <p className="font-black uppercase tracking-widest text-xs">Đang cập nhật mô tả</p>
 </div>
 )}
 </div>
 </TabsContent>
 ...
 <div className="p-10 rounded-[2.5rem] bg-card border border-border backdrop-blur-3xl focus-visible:outline-none">
 <h3 className="text-xl font-bold uppercase tracking-widest mb-8 border-l-4 border-primary pl-6">Kiến trúc kỹ thuật</h3>
 ...
 >
 <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-primary transition-colors">{spec.label}</span>
 ...
 <p className="font-black uppercase tracking-widest text-xs">Thông số đang cập nhật</p>
 </div>
 )}
 </div>
 </TabsContent>
 ...
 <div className="p-10 rounded-[2.5rem] bg-card border border-border backdrop-blur-3xl">
 <div className="flex flex-col md:row gap-8 items-start md:items-center justify-between mb-12 border-b border-border pb-10">
 <div>
 <h3 className="text-2xl font-black uppercase tracking-tight">Xác thực khách hàng</h3>
 ...
 className="h-12 px-8 rounded-xl bg-white text-slate-950 font-black text-[10px] uppercase tracking-widest hover:bg-white/90"
 >
