...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    if (!data.email.endsWith('@gmail.com')) {
      toast.error('Vui lòng sử dụng tài khoản Gmail để đăng nhập!');
      return;
    }
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Sử dụng tài khoản Gmail để đăng nhập vào hệ thống
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    pattern=".*@gmail\.com$"
                    title="Vui lòng sử dụng địa chỉ Gmail"
                  />
                </div>
                {errors.email && (
                  <p className="text-sm text-red-500">{errors.email.message}</p>
                )}
                <p className="text-xs text-gray-500">Chỉ chấp nhận tài khoản Gmail (@gmail.com)</p>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Button 
                  variant="outline" 
                  className="w-full" 
                  disabled={isGmailLoading || isSubmitting}
                ...
                >
                  ...
                  {isGmailLoading ? 'Đang kết nối...' : 'Đăng nhập với Google'}
                </Button>
                
                <p className="text-xs text-center text-gray-500 mt-4">
                  <ShieldCheck className="inline h-3 w-3 mr-1" />
                  Bảo mật bằng xác thực Google OAuth 2.0
                </p>
              </div>
            </div>
          </CardContent>
