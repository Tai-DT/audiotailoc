    ...
    if (!mounted) {
        return (
            <main className="min-h-screen bg-background flex flex-col items-center justify-center p-8">
                <div className="w-16 h-16 rounded-2xl bg-primary/10 animate-pulse mb-6" />
                <div className="h-6 w-64 rounded-full bg-muted/20 mb-4" />
                <div className="h-4 w-80 rounded-full bg-muted/10" />
            </main>
        );
    }
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-stretch">
                        ...
                        <div className="space-y-12">
                            <BlurFade delay={0.4} direction="left" inView>
                                <div className="space-y-12">
                                    {/* Services Card */}
                                    <div className="p-6 md:p-10 bg-white/5 border border-white/10 rounded-[2rem] md:rounded-[2.5rem] space-y-8 hover:border-accent/40 transition-colors">
                                        <div>
                                            <p className="text-accent font-black uppercase tracking-[0.3em] text-[10px] mb-2">Service Pillars</p>
                                            <h3 className="text-xl md:text-2xl font-black uppercase tracking-tight leading-none">Dịch vụ Đặc quyền</h3>
                                        </div>
                                    ...
                                    <div className="p-6 md:p-10 bg-white/5 border border-white/10 rounded-[2rem] md:rounded-[2.5rem] space-y-8">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-xl md:text-2xl font-black uppercase tracking-tight">Giải đáp <span className="text-foreground/40 dark:text-zinc-300 font-medium italic lowercase">FAQ</span></h3>
                    ...
                    <BlurFade delay={0.6} inView>
                        <div className="flex flex-col items-center gap-6 sm:gap-12 text-center">
                            <div className="space-y-4">
                                ...
                                <h2 className="text-3xl md:text-5xl font-black tracking-tighter leading-none uppercase italic">Tìm đường đến <span className="text-foreground/40 dark:text-zinc-300">Thánh đường</span></h2>
                            </div>

                            <div className="w-full max-w-6xl aspect-video md:aspect-[21/9] rounded-2xl sm:rounded-[3rem] overflow-hidden border-2 border-white/5 relative group p-1 bg-white/5 backdrop-blur-3xl shadow-3xl">
                                <div className="absolute inset-0 z-0">
                                    <div className="absolute inset-0 bg-card/50 flex flex-col items-center justify-center p-6 sm:p-12 text-center group-hover:bg-card/80 transition-colors">
