...
export default function ContactPage() {
    ...
    return (
        <main className="min-h-screen bg-background dark:bg-background text-foreground selection:bg-primary/30 pb-32">
            {/* Cinematic Hero */}
                    ...
                    <BlurFade delay={0.6} inView>
                        <div className="flex flex-col items-center gap-12 text-center">
                            ...
                            <div className="w-full max-w-6xl aspect-video rounded-[3rem] overflow-hidden border-2 border-white/5 relative group p-1 bg-white/5 backdrop-blur-3xl shadow-3xl">
                                <div className="absolute inset-0 z-0">
                                    <div className="absolute inset-0 bg-card/50 flex flex-col items-center justify-center p-12 text-center group-hover:bg-card/80 transition-colors">
