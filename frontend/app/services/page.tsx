...
function ServicesPageContent() {
 ...
 <p className="text-foreground/40 dark:text-zinc-300 text-sm sm:text-base md:text-lg font-medium leading-relaxed italic border-l-2 border-primary/20 pl-4 md:pl-6 max-w-lg">
 ...
 {/* Main Grid Content */}
 <section className="py-10 md:py-16" id="services-grid">
 <div className="container mx-auto px-4 md:px-6">
