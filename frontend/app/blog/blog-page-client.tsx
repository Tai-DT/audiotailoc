...
import type { BlogArticle, BlogCategory, PaginationMeta } from '@/lib/types';
...
function buildBlogUrl(next: { category?: string; q?: string }): string {
...
export default function BlogPageClient({
  ...
  const initialCategorySlug = first(initialSearchParams.category) ?? '';
          ...
          <BlurFade delay={0.1} inView>
            <div className="flex flex-col items-center text-center space-y-8">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1] max-w-5xl">
                Kiến Thức <span className="text-primary italic">Âm Thanh</span>
                <br />& <span className="text-accent italic">Tạp Chí</span> Hi-End
              </h1>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1">
            ...
            {/* Pagination Redesign (placeholder) */}
                        ...
                        {category._count && (
                          <span
                            className={cn(
                              ...
                              selectedCategory === category.slug ? 'bg-white/20 border-white/30' : 'bg-white/5 border-white/10',
                            )}
                          >
              ...
              <Card className="bg-white/5 border border-white/10 rounded-[2.5rem] backdrop-blur-xl overflow-hidden shadow-2xl">
                ...
                <CardContent className="p-4 md:p-6">
                  <div className="space-y-6">
                    {articles.slice(0, 5).map((article: BlogArticle, index) => (
