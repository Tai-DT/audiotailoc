...
export default function AboutPage() {
 ...
 <p className="text-3xl md:text-5xl font-black italic text-foreground dark:text-white leading-tight uppercase tracking-tighter font-display drop-shadow-2xl">
 ...
 <span className="text-[11px] font-black uppercase tracking-[0.4em] text-foreground/60 dark:text-zinc-200 font-display">Since 2014 • Elite Experience</span>
 </div>
 </div>
 </div>
 </div>
 ...
 {/* Call to Action Bar */}
 <section className="py-32 border-y border-border/40 bg-primary/[0.03] relative overflow-hidden">
 <div className="absolute inset-0 gold-royal-grain opacity-5 pointer-events-none" />
 <div className="container mx-auto px-6 relative z-10">
 <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16 text-center md:text-left">
 <div className="space-y-6">
 <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic font-display">Trải nghiệm <br /><span className="premium-text-gradient">Tinh hoa Trực tiếp</span></h3>
 <p className="text-muted-foreground text-lg font-medium italic max-w-lg">Khám phá không gian âm nhạc đích thực tại hệ thống showroom hiện đại nhất Việt Nam.</p>
 </div>
 <div className="flex flex-wrap justify-center gap-8">
 <Link href="/contact">
 <Button className="h-20 px-12 bg-foreground text-background hover:bg-primary hover:text-foreground dark:text-white rounded-[2rem] font-black uppercase tracking-widest transition-all text-xs flex items-center gap-4 shadow-2xl">
 Khám phá Showroom
 <ChevronRight className="w-5 h-5" />
 </Button>
 </Link>
 <Link href="/contact">
 <Button variant="outline" className="h-20 px-12 border-primary/20 bg-primary/5 text-primary hover:bg-primary hover:text-foreground dark:text-white rounded-[2rem] font-black uppercase tracking-widest transition-all text-xs shadow-xl">
 Liên hệ Chuyên gia
 </Button>
 </Link>
 </div>
