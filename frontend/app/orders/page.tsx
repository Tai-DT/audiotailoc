...
import { useCancelOrder, useOrders } from '@/lib/hooks/use-api';
...
function OrdersPageContent() {
 ...
 {isForbidden  ? 'Bạn không có quyền truy cập vào danh sách đơn hàng. Vui lòng liên hệ quản trị viên nếu bạn cần hỗ trợ.'
 ...
 {order.status && ['PENDING', 'CONFIRMED', 'PROCESSING'].includes(order.status) && (
 <Button
 variant="outline"
 size="sm"
