            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="mb-6 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white mb-2 tracking-tight">Khôi phục mật khẩu</h1>
                        <p className="text-zinc-300 text-sm">Nhập email để lấy lại quyền truy cập</p>
                    </div>
                        ...
                        {!isSubmitted ? (
                            ...
                            >
                                <div className="flex justify-center">
                                    <div className="w-20 h-20 bg-gradient-to-br from-green-500/20 to-green-900/20 rounded-full flex items-center justify-center border border-green-500/20 shadow-[0_0_40px_rgba(34,197,94,0.2)]">
                                        <CheckCircle2 className="w-10 h-10 text-green-500" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <h2 className="text-xl font-bold tracking-tight text-white">Kiểm tra email của bạn</h2>
                                    <p className="text-zinc-300 text-sm mx-auto">
                                        Chúng tôi đã gửi hướng dẫn đặt lại mật khẩu tới <span className="text-white font-medium block mt-1">{email}</span>
                                    </p>
                                </div>
                                ...
                                <div className="space-y-3 pt-2">
                                    <Button
                                        variant="outline"
                                        className="w-full h-11 bg-white/5 border-white/10 hover:bg-white/10 text-white rounded-xl font-semibold"
                                    ...
                                    <Link href="/auth/login" className="block w-full">
                                        <Button variant="ghost" className="w-full text-zinc-400 hover:text-white h-11 rounded-xl font-semibold hover:bg-white/5">
                                            Quay lại đăng nhập
                                        </Button>
                                    </Link>
                                </div>
