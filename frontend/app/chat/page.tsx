...
export default function ChatPage() {
 ...
 useEffect(() => {
 if (!guestPhone && contactInfo?.phone?.hotline) {
 setGuestPhone(contactInfo.phone.hotline)
 }
 ...
 <MessageCircle className="w-6 h-6 text-foreground dark:text-white" />
 </div>
 <div>
 ...
 : 'bg-gradient-to-br from-primary to-primary/80 text-foreground dark:text-white rounded-tr-none'
 }`}
 >
