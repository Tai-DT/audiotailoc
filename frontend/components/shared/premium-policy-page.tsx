                ...
                <div className="container mx-auto px-6 relative z-10 text-center space-y-8">
                    <BlurFade delay={0.1} inView>
                        <div className="flex flex-col items-center gap-6">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none font-display text-foreground">
                                {data.title}
                            </h1>
            ...
            <section className="py-24">
                <div className="container mx-auto px-6">
                    <BlurFade delay={0.2} inView>
                        <div className="max-w-4xl mx-auto p-12 lg:p-20 bg-card border border-border rounded-[3rem] shadow-2xl relative overflow-hidden">
