...
export default function CreateServiceReviewForm({
 ...
 {currentRating > 0 && `${currentRating} sao`}
 </span>
 </div>
 {errors.rating && (
 ...
 className="absolute -top-2 -right-2 bg-destructive text-foreground dark:text-white rounded-full p-1 hover:bg-red-600 transition-colors"
 >
 <X className="h-3 w-3" />
 </button>
 </div>
