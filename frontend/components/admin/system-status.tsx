...
export function SystemStatus() {
  ...
  const getStatusBadge = (status: 'healthy' | 'unhealthy' | 'degraded' | string) => {
    switch (status) {
      ...
      case 'degraded':
      case 'warning':
        return <Badge variant="outline" className="border-yellow-600 text-yellow-600">Degraded</Badge>;
      case 'unhealthy':
      case 'error':
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between text-sm mb-2">
                  ...
                  <span className={`font-medium ${
                    memoryPercentage > 80 ? 'text-red-600' :
                    memoryPercentage > 60 ? 'text-yellow-600' :
                    'text-green-600'
                  }`}>
              ...
              {diskUsage > 0 && (
                <div>
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className={`font-medium ${
                      diskUsage > 80 ? 'text-red-600' :
                      diskUsage > 60 ? 'text-yellow-600' :
                      'text-green-600'
                    }`}>
                      {diskUsage.toFixed(1)}%
                    </span>
