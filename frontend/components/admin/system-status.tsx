...
export function SystemStatus() {
 ...
 : (typeof healthData.checks.memory.details === 'object' && healthData.checks.memory.details !== null && 'percentage' in healthData.checks.memory.details ? (healthData.checks.memory.details as any).percentage : 0);
 const cpuUsage = healthData.performance?.cpu.usage || 0;
 const diskUsage = (typeof healthData.checks.disk.details === 'object' && healthData.checks.disk.details !== null && 'percentage' in healthData.checks.disk.details ? (healthData.checks.disk.details as any).percentage : 0);
 ...
 <span className={`font-medium ${cpuUsage > 80 ? 'text-destructive' :
 ...
 <div
 className={`h-2.5 rounded-full transition-all duration-500 ${cpuUsage > 80 ? 'bg-destructive' :
 ...
 <span className={`font-medium ${memoryPercentage > 80 ? 'text-destructive' :
 ...
 <div className="w-full bg-muted rounded-full h-2.5 overflow-hidden">
 <div
 className={`h-2.5 rounded-full transition-all duration-500 ${memoryPercentage > 80 ? 'bg-destructive' :
 ...
 <span className={`font-medium ${diskUsage > 80 ? 'text-destructive' :
 ...
 <div className="w-full bg-muted rounded-full h-2.5 overflow-hidden">
 <div
 className={`h-2.5 rounded-full transition-all duration-300 ${diskUsage > 80 ? 'bg-destructive' :
