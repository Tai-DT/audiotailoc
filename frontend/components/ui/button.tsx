  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:opacity-90 hover:shadow-lg hover:shadow-primary/25 hover-lift",
        audio: "bg-primary text-primary-foreground hover:bg-gradient-primary hover:shadow-lg hover:shadow-primary/25 hover-lift border border-primary/20",
        ...
        tertiary: "bg-tertiary text-tertiary-foreground hover:bg-tertiary/90 hover:shadow-md",
        info: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-md",
      },
      size: {
