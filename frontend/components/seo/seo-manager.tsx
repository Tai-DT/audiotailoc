...
export function SEOManager({ entity }: SEOManagerProps) {
 ...
 className="px-4 py-2 bg-primary text-foreground dark:text-white rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring"
 >
 Generate
 </button>
 </div>
 ...
 className="self-start px-4 py-2 bg-primary text-foreground dark:text-white rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring"
 >
 ...
 <button
 onClick={handleSave}
 className="px-6 py-2 bg-green-600 text-foreground dark:text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
 >
 Save SEO Data
 </button>
 <button
 ...
 className="px-6 py-2 bg-secondary text-foreground dark:text-white rounded-md hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-ring"
 >
 Reset
 </button>
 </div>
