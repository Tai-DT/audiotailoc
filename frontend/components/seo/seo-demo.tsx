...
export function SEODemo({ slug }: SEODemoProps) {
 ...
 const seoTitle = service?.seoTitle ?? service?.metaTitle ?? 'Not set';
 const seoDescription = service?.seoDescription ?? service?.metaDescription ?? 'Not set';
 const seoKeywords = service?.metaKeywords ?? 'Not set';
 ...
 <div>
 <strong>Meta Keywords:</strong> {seoKeywords}
 </div>
 <div>
